...
class ExampleUnitTest {
    ...
    @Test
    fun versionJsonOrderBy() {
        val type = object : TypeToken<List<String>>() {}.type
        val versions = Gson().fromJson<List<String>>(versionJson, type)
